...
export default async function handler(req: Req, res: Res) {
  // Wraps the entire handler — see api/signup/start.ts for the incident
  // that motivated always guaranteeing a JSON response over a crash.
  try {
    ...
    console.error("subscriptions/[id]: unhandled error escaped inner handling", outerErr);
