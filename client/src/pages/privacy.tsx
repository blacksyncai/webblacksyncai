  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        our CRM, form/email delivery, payment processing (Helcim, Square, and PayPal), and
        scheduling (Calendly) providers, and the telephony/SMS infrastructure that powers AI
        calling and texting</li>
      ...
      <p>
        ...
        <a href="mailto:admin@blacksync.network">Admin@blacksync.network</a>.
      </p>
